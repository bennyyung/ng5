...
module.exports = "<p>\n  Click this to <a href=\"\" (click)=\"sendMeHome()\"><strong>send me home</strong></a>\n</p>\n\n<ul>\n  <li *ngFor=\"let goal of goals\">\n    {{ goal }}\n  </li>\n</ul>"
...
var AboutComponent = /** @class */ (function () {
    function AboutComponent(route, router, _data) {
        ...
        this.router = router;
        this._data = _data;
        this.route.params.subscribe(function (res) { return console.log(res.id); }); //Get the id value from URL
    }
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.goals = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](['Data Service sample in the busket', 'Busket is not basket!']);
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(_data) {
        ...
        this.goals = ["Let's work hard and play hard!", "Go ahead and beyond!", "Nothing is possible!"];
    }
